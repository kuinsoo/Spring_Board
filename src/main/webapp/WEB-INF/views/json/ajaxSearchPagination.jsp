...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item kku-floatLeft"  >
                            <a class="page-link" href="javascript:ajaxsearchPage('${post_groupno}','${page-1}','10','${search}')">&laquo;</a>
                        </li>
                    </c:otherwise>
                </c:choose>
                    ...
                    <c:choose>
                        <c:when test="${page eq i.index}">
                            <li class="page-item active kku-floatLeft">
                                <a class="page-link" href="javascript:ajaxsearchPage('${post_groupno}','${i.index}','10','${search}')">${i.index}</a>
                            </li>
                        </c:when>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item kku-floatLeft">
                            <a class="page-link" href="javascript:ajaxsearchPage('${post_groupno}','${page+1}','10','${search}')">&raquo;</a>
                        </li>
                    </c:otherwise>
                </c:choose>
